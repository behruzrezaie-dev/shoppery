...
const Deal = () => {
  return (
    <div className='absolute ml-9 lg:ml-20'>
      ...
      <Timer />
      <div className='absolute hidden left-[360px] lg:left-[900px]  lg:bottom-[130px] bottom-[85px] md:left-[450px] md:bottom-[100px] bg-[#FF8A00] w-28 h-28 lg:w-40 lg:h-40 rounded-[50%] sm:flex sm:flex-col sm:justify-center sm:items-center'>
        <h1 className='text-white text-[30px] lg:text-[40px] font-semibold'>56%</h1>
        <p className='text-white lg:text-[22px] text-[19px] mt-[-5px]'>OFF</p>
      </div>
